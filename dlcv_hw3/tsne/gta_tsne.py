...
def main(argv):
    ...
    mnistm_dataset = MNISTM(image_path="./hw3_data/digits/mnistm/test", label_path="./hw3_data/digits/mnistm/test.csv", test_mode=False, transform=transform)
    svhn_dataset = SVHN(image_path="./hw3_data/digits/svhn/test", label_path="./hw3_data/digits/svhn/test.csv", test_mode=False, transform=transform)
    usps_dataset = USPS(image_path="./hw3_data/digits/usps/test", label_path="./hw3_data/digits/usps/test.csv", test_mode=False, transform=transform)
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(source_loader):
            ...
            outputs = F(inputs).contiguous().view(inputs.size(0), -1).cpu().numpy()
